	...
	public void resultProgDateStart() { // 실적시작일 입력
		while (true) {
			...
			try {
				...
				switch (ch) {
				case 1:
					resultProgressProjectStartInput();
					break;
				case 2:
					resultProgressSubDateStart();
					break;
				case 3:
					resultProgressCatDateStartInput();
					break;
				case 4:
					resultProgressOpDateStartInput();
					break;
				case 5:
					return;
				}
	...
	public void resultProgressPerOpDate() { // 소분류실적 입력
		...
		try {
			...
			if (result != 0) {
				...
				System.out.println("실적진척율의 최솟값은 1이상이며 최댓값은 100이어야 합니다");
