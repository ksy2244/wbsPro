...
public class EmployeeUI { // EmployeeUI로 이름 수정
	...
	private void companyManage() { // 업체 관리 메인 메뉴
		while (true) {
			...
			try {
				...
				case 3: deleteCompany(); break;
				case 4: searchCompany(); break;
				case 5: insertCompanyEmp(); break;
				case 6: updateCompanyEmp(); break;
				case 7: return;
	...
	private void deleteCompany() {
		...
		try {
			...
			switch (ch) {
			case 1: deleteCompanyCode(); break;
			case 2: deleteCompanyName(); break;
			case 3: deleteCompanyEmp(); break;
			case 4: return;
	...
	private void searchCompany() { // 업체 조회 서브 메뉴
		while (true) {
			...
			try {
				...
				switch (ch) {
				case 1: findByCompanyName(); break;
				case 2: findByCompanyCode(); break;
				case 3: listCompany(); break;
				case 4: findByCompanyEmpCode(); break;
				case 5: return; 
				}
	...
	private void findByCompanyCode() { // cooperSearchCode 
		...
		try {
			...
			if(list.size() == 0) {
				...
				System.out.println("업체코드\t업체명\t사원코드\t담당자명\t업체 전화번호"
									+ "\t입사일\t\t퇴사일");
	...
	private void findByCompanyEmpCode() { // cooperSearchCode
		...
		try {
			...
			if(dto == null) {
				...
				System.out.println("업체사원코드\t업체명\t사원코드\t담당자명"
									+ "\t업체전화번호\t\t입사일\t\t퇴사일");
	...
	/*
	private void findByCompanyEmpName() { // cooperSearchName
		// TODO Auto-generated method stub
		
	}

	private void listCompanyEmp() { 
		// TODO Auto-generated method stub
